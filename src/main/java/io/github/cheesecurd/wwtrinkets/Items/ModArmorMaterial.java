...
public class ModArmorMaterial implements ArmorMaterial
{
	...
	public ModArmorMaterial(int durabilityMult, int[] BASE_DURABILITY, int[] PROTECTION_VALUES, int enchantability, String name, SoundEvent equipSound, float toughness, float knockbackResistance, Item repairIngredient)
	{
